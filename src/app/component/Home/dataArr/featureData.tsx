export const featureData = [
  {
    title: "Get Started",
    description:
      "Connect with us to begin your journey. Whether you're buying or selling, we’re here to help.",
    icon: (
      <svg
      ...
      >
        <g fill="none" fillRule="evenodd">
          ...
          <g strokeWidth="2">
            <path
              className="stroke-current text-grayshade-400"
  ...
  },
  {
    ...
    description:
      "We dive deep into your needs and goals to ensure the best possible experience.",
    icon: (
      <svg
        className="w-16 h-16 p-1 -mt-1 mb-2"
        viewBox="0 0 64 64"
  ...
  },
  {
    ...
    description:
      "Review and finalize agreements to officially start working together.",
    icon: (
      <svg
        className="w-16 h-16 p-1 -mt-1 mb-2"
        viewBox="0 0 64 64"
  ...
  },
  {
    ...
    description:
      "We quickly create a prototype to validate your idea and align with market demands.",
    icon: (
      <svg
        className="w-16 h-16 p-1 -mt-1 mb-2"
        viewBox="0 0 64 64"
  ...
  },
  {
    ...
    description:
      "Our experts craft a polished product that meets industry trends and your expectations.",
    icon: (
      <svg
        className="w-16 h-16 p-1 -mt-1 mb-2"
        viewBox="0 0 64 64"
  ...
  {
    title: "Development & Marketplace Launch",
    description:
      "We finalize development and list your product for sale on our platform.",
    icon: (
      <svg
        className="w-16 h-16 p-1 -mt-1 mb-2"
        viewBox="0 0 64 64"
